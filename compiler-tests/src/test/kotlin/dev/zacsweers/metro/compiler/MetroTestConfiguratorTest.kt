...
class MetroTestConfiguratorTest {
  ...
  fun `min version - below exact dev build minimum`() {
    assertTrue(shouldSkip("2.3.0", minVersion = "2.4.20-dev-5625"))
    assertTrue(shouldSkip("2.4.20-dev-5624", minVersion = "2.4.20-dev-5625"))
  }

  @Test
  fun `min version - at exact dev build minimum`() {
    assertFalse(shouldSkip("2.4.20-dev-5625", minVersion = "2.4.20-dev-5625"))
  }
