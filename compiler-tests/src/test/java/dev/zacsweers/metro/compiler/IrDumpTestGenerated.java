...
public class IrDumpTestGenerated extends AbstractIrDumpTest {
  ...
  public void testAllFilesPresentInIr() {
    KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler-tests/src/test/data/dump/ir"), Pattern.compile("^(.+)\\.kt$"), Pattern.compile("^(.+)\\.k(?!2321\\b)\\w+\\.kt(s)?$"), true);
  }
  ...
  public class Aggregation {
    ...
    public void testAllFilesPresentInAggregation() {
      KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler-tests/src/test/data/dump/ir/aggregation"), Pattern.compile("^(.+)\\.kt$"), Pattern.compile("^(.+)\\.k(?!2321\\b)\\w+\\.kt(s)?$"), true);
    }
  ...
  public class Cycles {
    ...
    public void testAllFilesPresentInCycles() {
      KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler-tests/src/test/data/dump/ir/cycles"), Pattern.compile("^(.+)\\.kt$"), Pattern.compile("^(.+)\\.k(?!2321\\b)\\w+\\.kt(s)?$"), true);
    }
  ...
  public class Dependencygraph {
    ...
    public void testAllFilesPresentInDependencygraph() {
      KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler-tests/src/test/data/dump/ir/dependencygraph"), Pattern.compile("^(.+)\\.kt$"), Pattern.compile("^(.+)\\.k(?!2321\\b)\\w+\\.kt(s)?$"), true);
    }
    ...
    public class Dynamic {
      ...
      public void testAllFilesPresentInDynamic() {
        KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler-tests/src/test/data/dump/ir/dependencygraph/dynamic"), Pattern.compile("^(.+)\\.kt$"), Pattern.compile("^(.+)\\.k(?!2321\\b)\\w+\\.kt(s)?$"), true);
      }
    ...
    public class Interop {
      ...
      public void testAllFilesPresentInInterop() {
        KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler-tests/src/test/data/dump/ir/dependencygraph/interop"), Pattern.compile("^(.+)\\.kt$"), Pattern.compile("^(.+)\\.k(?!2321\\b)\\w+\\.kt(s)?$"), true);
      }
    ...
    public class Membernaming {
      ...
      public void testAllFilesPresentInMembernaming() {
        KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler-tests/src/test/data/dump/ir/dependencygraph/membernaming"), Pattern.compile("^(.+)\\.kt$"), Pattern.compile("^(.+)\\.k(?!2321\\b)\\w+\\.kt(s)?$"), true);
      }
    ...
    public class Sharding {
      ...
      public void testAllFilesPresentInSharding() {
        KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler-tests/src/test/data/dump/ir/dependencygraph/sharding"), Pattern.compile("^(.+)\\.kt$"), Pattern.compile("^(.+)\\.k(?!2321\\b)\\w+\\.kt(s)?$"), true);
      }
    ...
    public class Switchingproviders {
      ...
      public void testAllFilesPresentInSwitchingproviders() {
        KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler-tests/src/test/data/dump/ir/dependencygraph/switchingproviders"), Pattern.compile("^(.+)\\.kt$"), Pattern.compile("^(.+)\\.k(?!2321\\b)\\w+\\.kt(s)?$"), true);
      }
  ...
  public class Injectconstructor {
    ...
    public void testAllFilesPresentInInjectconstructor() {
      KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler-tests/src/test/data/dump/ir/injectconstructor"), Pattern.compile("^(.+)\\.kt$"), Pattern.compile("^(.+)\\.k(?!2321\\b)\\w+\\.kt(s)?$"), true);
    }
  ...
  public class Multibindings {
    ...
    public void testAllFilesPresentInMultibindings() {
      KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler-tests/src/test/data/dump/ir/multibindings"), Pattern.compile("^(.+)\\.kt$"), Pattern.compile("^(.+)\\.k(?!2321\\b)\\w+\\.kt(s)?$"), true);
    }
  ...
  public class Provides {
    ...
    public void testAllFilesPresentInProvides() {
      KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler-tests/src/test/data/dump/ir/provides"), Pattern.compile("^(.+)\\.kt$"), Pattern.compile("^(.+)\\.k(?!2321\\b)\\w+\\.kt(s)?$"), true);
    }
  ...
  public class Visibility {
    ...
    public void testAllFilesPresentInVisibility() {
      KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler-tests/src/test/data/dump/ir/visibility"), Pattern.compile("^(.+)\\.kt$"), Pattern.compile("^(.+)\\.k(?!2321\\b)\\w+\\.kt(s)?$"), true);
    }
