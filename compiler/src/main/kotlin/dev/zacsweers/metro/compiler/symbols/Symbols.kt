...
internal class Symbols(
  ...
  object StringNames {
    ...
    const val TEMPLATE_TARGET = "TemplateTarget"
  }
  ...
  object ClassIds {
    ...
    val contributesTemplate = ClassId(FqNames.metroRuntimePackage, "ContributesTemplate".asName())
    ...
    val metroTemplateScope =
      contributesTemplate.createNestedClassId(StringNames.TEMPLATE_SCOPE.asName())
    val metroTemplateTarget =
      contributesTemplate.createNestedClassId(StringNames.TEMPLATE_TARGET.asName())
    val contributesTemplateTemplate =
      contributesTemplate.createNestedClassId(StringNames.TEMPLATE.asName())
  ...
  object Names {
    ...
    val template = StringNames.TEMPLATE_PARAM.asName()
