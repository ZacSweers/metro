  ...
  companion object {
    fun create(
      ...
      return IcCapabilities(
        automaticDeclarationFinderTracking =
          compatContext.supportsAutomaticDeclarationFinderTracking,
        annotationArgumentInvalidation = compatContext.supportsAnnotationArgumentInvalidation,
