    ...
    compile(
      ...
      assertDiagnostics(
        ...
        e: ExampleGraph.kt:8:11 [Metro/DuplicateBinding] Multiple bindings found for other.OtherClass
          ...
          Unknown source location, this may be generated by the compiler.
        └─ Here's some additional information we have for the binding:
           ├─ Binding type: Provided
           └─ Binding information: other.ExampleClass2 contributes a binding of OtherClass
        ...
        └─ Here's some additional information we have for the binding:
           ├─ Binding type: Provided
           └─ Binding information: other.ExampleClass contributes a binding of OtherClass
