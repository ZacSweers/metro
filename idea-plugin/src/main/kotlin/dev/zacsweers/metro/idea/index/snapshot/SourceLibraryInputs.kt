...
/** Captures source ownership, factory expansion, and library seeds in the snapshot read action. */
...
/** Resolves requesting modules and source-factory seeds while source pointers remain readable. */
