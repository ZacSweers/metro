...
public class BetweennessCentrality<V>
{
     ...
     */
    public BetweennessCentrality(Graph<V> graph)
    {
        this(graph, false);
    }
     ...
     */
    public BetweennessCentrality(Graph<V> graph, boolean normalize)
    {
    ...
    public BetweennessCentrality(
        Graph<V> graph, boolean normalize, OverflowStrategy overflowStrategy)
    {
