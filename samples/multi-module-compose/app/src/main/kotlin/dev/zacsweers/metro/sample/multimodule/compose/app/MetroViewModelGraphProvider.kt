...
import dev.zacsweers.metro.sample.multimodule.compose.core.ViewModelGraph
import dev.zacsweers.metro.sample.multimodule.compose.core.ViewModelGraphProvider
import kotlin.reflect.KClass
import kotlin.reflect.cast

@Inject
@ContributesBinding(AppScope::class)
class MetroViewModelGraphProvider(private val appGraph: MetroAppGraph) :
  ViewModelGraphProvider {
